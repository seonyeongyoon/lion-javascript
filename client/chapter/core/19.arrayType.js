...
// 배열 선언
//split : 배열을 만들어 줌(string(=문자인 객체)의 기능)
let friends = '진승,혜미,승미,효윤,선용,승민,상호,영은,희소'.split(',');
console.log(friends);

// 배열 요소의 총 갯수
console.log(friends.length = 3);//배열 갯수 변경
...
// 배열 요소 추가
let unshift = friends.unshift('진승');//배열의 앞에 추가
console.log(friends);

let push = friends.push('동균');//배열의 뒤에 추가
console.log(friends);
