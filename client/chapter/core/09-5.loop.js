...
/* For Of Loop     */
/* --------------- */
//객체는 iterable하지 않기 때문에 For of 사용 불가능
...
// for(let value of arrayLike) {09-5.loop.js:18 Uncaught TypeError: arrayLike is not iterable
//   console.log(value);
// }
...
for(let value of languages) {
  ...
  if (name.includes('Java') && name.includes) break;
  //if (name === 'Java') break;
...
for(let keyValue of Object.entries(randomUser)){//모든 key값을 배열로 반환
  let key = keyValue[0];
